...
const Hero: React.FC<HeroProps> = ({ onStageSelect }) => {
  const startStage = {
    id: 'pre-seed' as Stage,
    label: 'Getting Started',
    description: 'Begin your GitHub optimization journey',
    benchmarks: {
      deploymentFreq: 'weekly',
      securityLevel: 1,
      costEfficiency: 1,
      expectedScores: { overall: 1 }
    }
  };
  ...
  return (
    <section className="hero" role="banner">
      ...
      <div className="value-pill" role="complementary">
        <svg className="github-logo" height="24" viewBox="0 0 16 16" width="24" aria-label="GitHub Logo">
      ...
      <ul className="value-stack" role="list">
